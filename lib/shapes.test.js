...
describe("shape", () => {
  it("Square renders correctly", () => {
    ...
    const expectedValue = `<svg version="1.1" width="300" height="200" viewBox="0, 0, 100, 100" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect width="400" height="400" style="fill:Green" />

        <text x="62" y="62" font-size="50" text-anchor="middle" fill="WHite">SVG</text> 
  ...
  it("Triangle renders correctly", () => {
    const triangle = new Triangle("SVG", "Green", "White")
    const expectedValue = `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">

        <polygon points="200,50 70,275 330,275" style="fill:Green" />

        <text x="200" y="165" font-size="45" text-anchor="middle" fill="White">SVG</text> 
